...
const CA_VELOCITYARRAY = [-10, -9.5, -09, -8.5, -08, -7.5, -07, -6.5, -06, 
                           06,  6.5,  07,  7.5,  08,  8.5,  09,  9.5,  10];
...
function setup() {
  ...
  html_volume(ca_spaceSound);// Register slider event to alter volume
...
function ca_startPause() {
  console.log('%c ca_startPause(): html_gameActive= ' + html_gameActive +
...
function ca_createAlienSprites() { 
  ...
  for (var i = 0; i < ca_levelArray[ca_level].numAliens; i++) {
    ca_x = random(ca_levelArray[ca_level].alienDia/2, 
                  width-ca_levelArray[ca_level].alienDia/2)
    ca_y = random(ca_levelArray[ca_level].alienDia/2, 
                  height-ca_levelArray[ca_level].alienDia/2)
           
    ca_alien = new Sprite(ca_x, ca_y, ca_levelArray[ca_level].alienDia, 'd');
    ca_alien.vel.x = random(CA_VELOCITYARRAY) * ca_levelArray[ca_level].velScale;
    ca_alien.vel.y = random(CA_VELOCITYARRAY) * ca_levelArray[ca_level].velScale;
    //ca_alien.vel.x = 0;
    //ca_alien.vel.y = 0;
...
function ca_createTerminators() { 
  ...
  for (var i = 0; i < ca_levelArray[ca_level].numTerminators; i++) {
    ca_x = random(ca_levelArray[ca_level].alienDia/2, 
                  width-ca_levelArray[ca_level].alienDia/2)
    ca_y = random((height-ca_levelArray[ca_level].alienDia/2)/2, 
                  height-ca_levelArray[ca_level].alienDia/2)
           
    ca_terminator = new Sprite(ca_x, ca_y, ca_levelArray[ca_level].alienDia/2, 'd');
    ca_terminator.vel.x = random(CA_VELOCITYARRAY) * ca_levelArray[ca_level].velScale;
    ca_terminator.vel.y = random(CA_VELOCITYARRAY) * ca_levelArray[ca_level].velScale;
...
function ca_createWalls() {
  ...
  wallLH  = new ca_wallGroup.Sprite(      0, height/2,     8, height, 'k');	
  wallRH  = new ca_wallGroup.Sprite(  width, height/2,     8, height, 'k');
  wallTop = new ca_wallGroup.Sprite(width/2,        0, width,      8, 'k');          
	wallBot = new ca_wallGroup.Sprite(width/2,   height, width,      8, 'k');
