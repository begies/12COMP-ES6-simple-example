...
//const SI_VELOCITYARRAY = [-10, -9.5, -09, -8.5, -08, -7.5, -07, -6.5, -06, 
...
function si_createTerminators() { 
  ...
  for (var i = 0; i < si_levelArray[si_level].numTerminators; i++) {
    ...
    //si_terminator.vel.x = random(CA_VELOCITYARRAY) * si_levelArray[si_level].velScale;
    //si_terminator.vel.y = random(CA_VELOCITYARRAY) * si_levelArray[si_level].velScale;
