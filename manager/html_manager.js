...
console.log('%c html_manager.js \n--------------------', 
            'color: blue; background-color: white;');

const HTML_NUMLBOARD = 10;
var html_debugStatus = 'n';
...
// Call firebase initialise & set default sessionStorage for debug
// Input:  n/a
// Return: n/a
/**************************************************************/
function html_index() {
  ...
  sessionStorage.setItem('html_debugStatus', html_debugStatus);
  p_debug.textContent = html_debugStatus;
}

/**************************************************************/
// html_load()
// Called by select_game.html, non index.html onload & GAME SELECTION button
// Get sessionStorage data & display user's photo & firebaee I/O status
// Input:  n/a
// Return: n/a
/**************************************************************/
function html_load() {
  ...
  html_debugStatus         = sessionStorage.getItem('html_debugStatus');
  p_debug.textContent      = html_debugStatus;
...
/**************************************************************/
function html_debug() {
  console.log('%c html_debug(): ',
              'color: ' + HTML_COL_C + '; background-color: ' + HTML_COL_B + ';');
  
  var html_volumeSlider = document.getElementById('i_vol');
  html_volumeSlider.addEventListener("change", function(e) {
    _audio.setVolume(e.currentTarget.value/100);
  })
}
...
/**************************************************************/
// html_remClass(_targetClass, _remClass)
// Called by various
...
/**************************************************************/
export { HTML_NUMLBOARD, html_gameActive, html_debugStatus, 
         html_index, html_load, html_gameSelection, html_buildCanvas,  
         html_mouseTrail, html_volume, html_debug, html_posElement,
